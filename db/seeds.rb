...
student_5 = Student.create!(school: school_2, name: "Meredith Smith", english_learner: true, grade: 5)
student_6 = Student.create!(school: school_2, name: "Chan Sue", english_learner: false, grade: 2)
